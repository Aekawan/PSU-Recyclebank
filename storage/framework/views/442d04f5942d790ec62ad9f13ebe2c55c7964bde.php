...
<div class="panel-footer">
  <?php if(isset($userinfo) && $userinfo->count() > 0): ?>
  <div class="text-center">
    <a href="<?php echo e(route('account.withdraw', $userinfo[0]->id)); ?>" type="button" class="btn btn-lg btn-danger"  name="button">- ถอน</a>
    <a href="<?php echo e(route('account.deposit', $userinfo[0]->id)); ?>" type="button" class="btn btn-lg btn-success" style="margin-left:50px" name="button">+ ฝาก</a>
  </div>
  <?php endif; ?>
</div>
</div>
