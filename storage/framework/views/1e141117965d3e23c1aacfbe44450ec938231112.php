...
<?php if(isset($news)): ?>
  ...
  <div class="panel-footer">
    ...
    <div class="text-center">
      <a href="#" type="button" name="button" class="btn btn-lg btn-outline-green-back" style="width:150px">ย้อนกลับ</a>
      <button type="button" id="btn-submit" class="btn btn-lg btn-green" style="width:150px;margin-left:20px">แก้ไข</button>
    </div>
    <?php endif; ?>
  </div>
  </form>
