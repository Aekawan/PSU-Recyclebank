          ...
          <tbody>
            <?php $__currentLoopData = $news; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $new): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
                ...
                <td><?php if($new->slid_on == true): ?> แสดง <?php else: ?> ไม่แสดง <?php endif; ?></td>
                <td><?php echo e($new->updated_at); ?></td>
                <td>
                  <a href="<?php echo e(route('news.show',$new->id)); ?>" type="button" class="btn btn-info" name="button"><i class="fa fa-eye"></i></a>
                  <a href="<?php echo e(route('news.edit',$new->id)); ?>" type="button" class="btn btn-warning" name="button"><i class="fa fa-pencil"></i></a>
                  <a href="<?php echo e(route('news.delete',$new->id)); ?>" onclick="return confirm('คุณต้องการลบข่าวสารนี้หรือไม่?')" type="button" class="btn btn-danger" name="button"><i class="fa fa-trash"></i> </a>
                </td>
              </tr>
