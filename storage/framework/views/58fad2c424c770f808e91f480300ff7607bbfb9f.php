        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
           ...
           <div class="panel-footer">
             <button type="submit" name="button" class="btn btn-lg btn-green" style="width:150px"><i class="fa fa-plus"></i> เพิ่ม</button>
             <button type="submit" name="button" class="btn btn-lg btn-outline-green-back" style="width:150px"><i class="fa fa-back"></i> ย้อนกลับ</button>
           </div>
        </div>
      </form>
      </div>
