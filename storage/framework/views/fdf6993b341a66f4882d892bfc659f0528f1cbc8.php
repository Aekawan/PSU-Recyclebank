...
<div class="row">
   ...
   <form class="" action="<?php echo e(route('news.insert')); ?>" enctype="multipart/form-data" method="post" runat="server">
     <?php echo e(csrf_field()); ?>

   <div class="col-lg-12" style="margin-bottom:20px">
     <h4>หัวข้อ:</h4>
     <input type="text" class="form-control" name="title" value="" placeholder="พิมพ์หัวข้อข่าวสารที่ต้องการ....">
   </div>
   <div class="col-lg-12">
     <hr>
   </div>
   ...
   <div class="col-lg-12">
     ...
     <textarea name="content" id="editor" class="custom-editor"></textarea>
   </div>
   <div class="col-lg-12" style="margin-top:5px;style="margin-bottom:20px"">
     <h4>ต้องการให้แสดงข่าวสารนี้บนสไลด์หรือไม่  <input type="checkbox" id="slid_on" class="form-color" name="slid_on" value="false"></h4>
   </div>
   <div class="col-lg-12 text-center" style="margin-bottom:20px">
     <button type="submit" class="btn btn-lg btn-green" name="button" style="width:200px">ส่งข่าวสาร</button>
     <button type="button" class="btn btn-lg btn-outline-green-back" name="button" style="width:200px">ย้อนกลับ</button>
   </div>
