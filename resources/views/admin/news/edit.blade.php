...
<div class="row">
   ...
   <form class="" action="{{route('news.update',$news->id)}}" enctype="multipart/form-data" method="post" runat="server">
     {{ csrf_field() }}
   <div class="col-lg-12" style="margin-bottom:20px">
     <h4>หัวข้อ:</h4>
     <input type="text" class="form-control" name="title" value="{{$news->title}}" placeholder="พิมพ์หัวข้อข่าวสารที่ต้องการ....">
   </div>
   <div class="col-lg-12">
     <hr>
   </div>
   ...
   <div class="col-lg-4" style="margin-bottom:20px">
     ...
     <div class="panel green panel-defualt" style="height:200px;width:350px;padding:0px">
       <img id="imgPreview" src="{{asset('img/news/preview/'.$news->img_preview)}}" alt="" style="height:198px;width:100%;">
     </div>
   ...
   <div class="col-lg-8" style="margin-bottom:20px">
     ...
     <div class="panel green panel-defualt" style="height:200px;width:100%;padding:0px">
        <img id="imgFull" src="{{asset('img/news/full/'.$news->img_full)}}" alt="" style="height:198px;width:100%;">
     </div>
     <div class="text-center">
       <div class="upload-btn-wrapper">
         <button class="btn btn-outline-green-back">เลือกรูปภาพ</button>
   ...
   <div class="col-lg-12">
     ...
     <textarea name="content" id="editor" class="custom-editor">{!! $news->content !!}</textarea>
   </div>
   <div class="col-lg-12" style="margin-top:5px;style="margin-bottom:20px"">
     <h4>ต้องการให้แสดงข่าวสารนี้บนสไลด์หรือไม่  <input type="checkbox" id="slid_on" class="form-color" name="slid_on" value="{{$news->slid_on}}" @if($news->slid_on != null) checked @endif ></h4>
   </div>
